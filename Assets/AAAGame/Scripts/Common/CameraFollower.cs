...
{
    public bool enableDepthTex = false;
    ...
    {
        GetComponent<Camera>().depthTextureMode = enableDepthTex ? DepthTextureMode.Depth : DepthTextureMode.None;
        mainCam.cullingMask = ~LayerMask.GetMask("UI", "WorldUI");
        InitURP();
    }
