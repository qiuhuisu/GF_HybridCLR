...
public class PreloadProcedure : ProcedureBase
{
    ...
    {
        var assetName = UtilityBuiltin.ResPath.GetLanguagePath(GF.Localization.Language.ToString());
        GF.Localization.ReadData(assetName, this);
    }
    ...
    private void OnLoadDicFailure(object sender, GameEventArgs e)
    {
        ...
        Log.Error("Load Dictionary Failed:{0}", args.ErrorMessage);
    }
    ...
    private void OnLoadDataTableFailure(object sender, GameEventArgs e)
    {
        ...
        Log.Error("Load DataTable Failed:{0}", args.ErrorMessage);
    }
    ...
    private void OnLoadConfigFailure(object sender, GameEventArgs e)
    {
        ...
        Log.Error("Load Config Failed:{0}", args.ErrorMessage);
    }
}
